...
const balleSchema = new mongoose.Schema(
  {
    nom: { type: String, required: [true, "Le nom de la balle est requis"], trim: true },
    numero: { type: String, required: [true, "Le numéro de la balle est requis"], unique: true, trim: true },
    prixAchat: { type: Number, required: [true, "Le prix d'achat est requis"], min: 0 },
    dateAchat: { type: Date, default: Date.now },
    description: { type: String, trim: true },
    statut: { type: String, enum: ["en_stock", "en_vente", "vendu", "archivé"], default: "en_stock" },
    totalVentes: { type: Number, default: 0 },
    nombreVentes: { type: Number, default: 0 },
    depensesLiees: { type: Number, default: 0 },

...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    else toast.error(result.message || "Erreur de connexion");
  };
  return (
      ...
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="password" name="motDePasse" className="form-input" placeholder="••••••••" value={formData.motDePasse} onChange={handleChange} required />
          </div>
